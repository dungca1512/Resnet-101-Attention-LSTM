...
#         print (sentence, img_id)
    ...
    BLEU1,BLEU2, BLEU3, BLEU4 = evaluate_captions( true_annotations_file, pred_annotations_file )
    print("Test Loss : %.2f"%(test_loss))
    print("BLEU1 score : %.2f"%(BLEU1))
    print("BLEU2 score : %.2f"%(BLEU2))
    print("BLEU3 score : %.2f"%(BLEU3))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_dir', type=str, default = "cnn_lstm", help='input image for generating caption')
    parser.add_argument('--caption_path', type=str, default = "nocaps.json", help='test captions for evaluation')  # validation set of coco is used as test.
    parser.add_argument('--encoder_path', type=str, default='models/van/encoder-3.ckpt', help='path for trained encoder')
    parser.add_argument('--decoder_path', type=str, default='models/van/decoder-3.ckpt', help='path for trained decoder')
