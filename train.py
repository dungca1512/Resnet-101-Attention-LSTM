...
def main(args):
    ...
    encoder.load_state_dict(torch.load('./models/van/encoder-1.ckpt')) # put checkpoint name
    decoder.load_state_dict(torch.load('./models/van/decoder-1.ckpt'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_dir', type=str, default='data\\train2014', help='directory for resized images')
    ...
    parser.add_argument('--val_image_dir', type=str, default='data\\val2014', help='directory for resized validation images')
