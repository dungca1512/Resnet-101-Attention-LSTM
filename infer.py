...
def main(args):
    ...
    sampled_ids = decoder.sample(feature, False)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--encoder_path', type=str, default='models/eca/encoder-3.ckpt', help='path for trained encoder')
    parser.add_argument('--decoder_path', type=str, default='models/eca/decoder-3.ckpt', help='path for trained decoder')
